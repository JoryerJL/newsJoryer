...
| Plan QA funcional | Codex | `docs/qa/<phase>-functional-test-plan.md` | Casos ejecutables y criterios de bloqueo |
...
- El plan QA existe antes de implementar y se entrega a Antigravity en cada fase.
